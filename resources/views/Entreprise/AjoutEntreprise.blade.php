...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="card" style="max-width:75rem;margin-left:auto;margin-right:auto;">
			...
			<div class="card-body">
				{{ Form::open(['route' => 'EntrepriseEnregistrer']) }}
          ...
          <div class="form-group" style="margin-top:10px;">
  					...
  					{!! $errors->first('ville', '<small class="form-text text-muted">:message</small>') !!}
  				</div>
          <div class="form-group" style="margin-top:10px;">
          ...
          <div class="form-group" style="margin-top:10px;">
					...
					<table class="table table-striped">
						...
						<tbody>
							<tr>
								 <td>{{ Form::text('utilisateur','XX', ['class' => 'form-control']) }}</td>
