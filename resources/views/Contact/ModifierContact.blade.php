...
<div class="row">
	...
	<div class="col-sm-3">
			...
			{{ link_to_route('FicheContact', 'Annuler',['id'=>$contact->id],['class' => 'btn btn-danger pull-right', 'style' => 'margin-top:10px;margin-right:25px;height:2.5rem;width:15rem;margin-bottom:15px;' ]) }}
		{{ Form::close() }}
	</div>
</div>
@endsection
