...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="card" style="max-width:75rem;margin-left:auto;margin-right:auto;">
			...
			<div class="card-body">
				{{ Form::model($groupe,['route' => ['GroupeMAJ',$groupe->id],'method' => 'put']) }}
	...
	<div class="col-sm-3">
			{{ Form::submit('Valider', ['class' => 'btn btn-info pull-right', 'style' => 'margin-top:68px;margin-right:25px;height:2.5rem;width:15rem;margin-bottom:20px;' ]) }}
